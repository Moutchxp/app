                  ...
                  <td style={{ padding: "3px 8px", color: "var(--color-svv-ink)" }}>
                    ...
                    {ligne.depliable && (
                      <>
                        ...
                        <style>{`.svv-info-btn{position:relative;display:inline-flex;align-items:center;justify-content:center;width:19px;height:19px;margin-left:6px;vertical-align:middle;border-radius:9999px;border:1.5px solid var(--color-svv-ink);background:var(--color-svv-surface);color:var(--color-svv-ink);font-family:Georgia,'Times New Roman',serif;font-style:italic;font-weight:700;font-size:12px;line-height:1;cursor:pointer;transition:background-color .12s ease,color .12s ease}.svv-info-btn::before{content:"";position:absolute;inset:-4px;border-radius:9999px}.svv-info-btn:hover{background:var(--color-svv-ink);color:var(--color-svv-bg)}.svv-info-btn:focus-visible{background:var(--color-svv-ink);color:var(--color-svv-bg);outline:2px solid var(--color-svv-red);outline-offset:2px}@media (prefers-reduced-motion: reduce){.svv-info-btn{transition:none}}`}</style>
                        <button
                          ref={boutonRef}
                          type="button"
...
function ModaleCalcul({ a, t, index, profilActif, profilTest, onFermer }: { a: LigneVentil; t: LigneVentil; index: number; profilActif: ProfilDegagement; profilTest: ProfilDegagement; onFermer: () => void }) {
  ...
  return (
    ...
    >
      <style>{`@keyframes svvModaleIn{from{opacity:0;transform:translateY(6px)}to{opacity:1;transform:none}}.svv-expr-clamp{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.svv-info-btn-sm{position:relative;display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;border-radius:9999px;border:1.5px solid var(--color-svv-ink);background:var(--color-svv-surface);color:var(--color-svv-ink);font-family:Georgia,'Times New Roman',serif;font-style:italic;font-weight:700;font-size:10px;line-height:1;cursor:pointer;transition:background-color .12s ease,color .12s ease}.svv-info-btn-sm::before{content:"";position:absolute;inset:-5px;border-radius:9999px}.svv-info-btn-sm:hover{background:var(--color-svv-ink);color:var(--color-svv-bg)}.svv-info-btn-sm:focus-visible{background:var(--color-svv-ink);color:var(--color-svv-bg);outline:2px solid var(--color-svv-red);outline-offset:2px}@media (prefers-reduced-motion: reduce){.svv-modale-calcul{animation:none!important}.svv-info-btn-sm{transition:none}}`}</style>
      <div
        ref={dialogRef}
        role="dialog"
        aria-modal="true"
