 ...
 */
export type CleOnglet = 'dossiers' | 'a_demander' | 'en_cours' | 'reponses' | 'archives' | 'saisines' | 'reglages' | 'automatisation' | 'collaborateurs' | 'rattachement' | 'trace_emprise';
...
export const GROUPES_ONGLETS: { titre: string; onglets: { cle: CleOnglet; libelle: string }[] }[] = [
  ...
  // PROJ-2 — « Tracé emprise » = tracé manuel assisté de l'emprise d'un futur bâtiment, calé sur la parcelle (reconstitution, jamais une mesure).
  { titre: 'Mise à jour des dossiers', onglets: [{ cle: 'dossiers', libelle: 'Dossiers' }, { cle: 'automatisation', libelle: 'Automatisation' }, { cle: 'rattachement', libelle: 'Rattachement' }, { cle: 'trace_emprise', libelle: 'Tracé emprise' }] },
