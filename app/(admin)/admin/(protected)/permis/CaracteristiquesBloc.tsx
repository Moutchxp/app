...
import type { ParcelleLigne, EmpreinteLigne } from '../../../../lib/permis/parcellesRepo';
...
interface EtatCharge { faits: FaitsPermis; global: GlobalPermis | null; corps: CorpsBatiment[]; bornes: BornesParColonne; journal: JournalPermis; naturesPossibles: string[]; piecesParNom?: Record<string, number>; destinationsPossibles?: string[]; parcelles?: ParcelleLigne[]; empreinte?: EmpreinteLigne | null }
...
export function CaracteristiquesBloc({ dossierId, onTelecharger }: { dossierId: number; onTelecharger?: (id: number, source: 'reponse' | 'dossier') => void }) {
  ...
  return (
    <div className="flex flex-col gap-3" style={{ marginTop: '.6rem' }}>
      ...
      <FaitsPermisBloc faits={data.faits} nbBatiments={data.corps.length} parcelles={data.parcelles} empreinte={data.empreinte}
