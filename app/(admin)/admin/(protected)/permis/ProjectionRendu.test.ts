...
const ligne = (over: Partial<LigneProjectionAffichee> = {}): LigneProjectionAffichee => ({
  dossierId: 11434, numDau: 'PC07512025V0035', communeNom: 'Paris 15e', natureLibelle: 'Construction neuve', nbBatiments: 2, satisfaitLe: '2026-07-01', nbCorpsSansAltitude: 0, nbBatimentsValide: 2, nbCorpsSansAltValidee: 2, nbCorpsSansEmpriseValidee: 2, nbCorpsNonEnregistres: 0, projectionValidee: false, testeEnAnalyse: false, plancheEtat: null, ...over,
});
