...
/** Onglets de la tuile « Permis de construire » : Dossiers (veille/liste), Demandes (constitution — S7) et Réglages (S7d). */
...
export function PermisTuile({ depuisParDefaut, categories }: Props) {
  const [onglet, setOnglet] = useState<'dossiers' | 'demandes' | 'reglages'>('dossiers');
