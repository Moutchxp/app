    ...
    <div className="flex flex-col gap-4">
      ...
      {edition && (
        <div className="svv-card" style={{ display: 'flex', flexWrap: 'wrap', gap: '.6rem', alignItems: 'center' }}>
          ...
          {/* 221 — 2e e-mail : contact DIRECT d'une personne (facultatif, INFORMATIF). JAMAIS destinataire : les demandes partent à
              l'e-mail du SERVICE (ci-dessus) ; n'affecte ni le rail ni la chaîne d'envoi. Jamais alimenté par la PRADA (S21). */}
          <div className="flex flex-col gap-1" style={{ flex: '1 1 260px', minWidth: 0 }}>
            <label style={{ fontSize: 12, color: 'var(--color-svv-muted)', display: 'flex', flexDirection: 'column', gap: '.15rem' }}>
              E-mail direct <span style={{ fontStyle: 'italic' }}>(contact d’une personne — facultatif)</span>
            ...
            <span style={{ fontSize: 11, color: 'var(--color-svv-muted)', lineHeight: 1.4 }}>Les demandes ne partent PAS à cette adresse (le destinataire reste l’e-mail du service).</span>
          </div>
