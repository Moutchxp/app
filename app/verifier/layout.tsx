...
/**
 * Layout de SEGMENT pour /verifier : charge les polices de marque Sans Vis-à-Vis® (titres = Space Grotesk, texte = Public
 * Sans, identifiants = IBM Plex Mono) et les expose en VARIABLES CSS sur un wrapper. Next 16 : les polices sont scopées au
 * composant qui les applique (docs 01-app/…/13-fonts.md) → le tunnel (app/page.tsx) et l'admin, servis par le layout RACINE
 * (Geist), NE sont PAS affectés. Le wrapper porte aussi `.svv-verif` (police de texte par défaut du segment).
 */
