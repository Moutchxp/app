...
const EMAIL = [
  ...
  'envois_max_par_run', 'envois_max_par_jour', 'envois_auto_max_par_demande_run', 'email_envoi_initial_auto_active', 'relance_auto_active', 'cascade_partiel_auto_active', 'envoi_heure_debut', 'envoi_heure_fin',
