...
const EMAIL = [
  ...
  'envois_max_par_run', 'envois_max_par_jour', 'envois_auto_max_par_demande_run', 'relance_auto_active', 'cascade_partiel_auto_active', 'envoi_heure_debut', 'envoi_heure_fin',
