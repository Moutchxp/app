...
describe('resoudreSommet — tier 3 (estimation par étages, immeuble voisin)', () => {
  // nature/annee/impact_pt_wkt : champs d'enrichissement Couche 1 B, ignorés par resoudreSommet.
  const base = { id: 1, cleabs: 'TEST', dist_m: 30, nature: null, annee: null, corridor_wkt: '', axe_wkt: '', impact_pt_wkt: '' };
