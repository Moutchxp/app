...
const decision = (): DecisionNiveaux => ({
  corps: [
    { repere: '2D1', niveaux: [], sources: [src('PC3.pdf', 2)], nbPieces: 3,
      ...
      sommet: { valeur: 88.91, confiance: 'confirmee', qualif: 'acrotere', label: 'Acrotère', sources: [src('PC3.pdf', 2)], note: null },
    ...
    { repere: '2D2', niveaux: [], sources: [src('PC3.pdf', 2)], nbPieces: 3,
      ...
      nbSousSol: { valeur: 1, confiance: 'confirmee', sources: [src('PC3.pdf', 2)] },
      sommet: { valeur: 86.11, confiance: 'confirmee', qualif: 'toiture', label: 'TOITURE', sources: [src('PC3.pdf', 2)], note: 'acrotère 87.13 vu sur 1 pièce seulement (non corroboré) → non retenu' },
      gardeCorps: [] },
  ],
