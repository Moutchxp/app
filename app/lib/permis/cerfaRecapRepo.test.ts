...
const STOCKE: DeclarationsCerfaStockees = {
  declarations: { present: true, descriptionProjet: 'depuis la base', descriptionProjetProvenance: 'texte',
    descriptionScission: { genere: null, humain: 'depuis la base', valeurs: null }, dateDepot: null, superficieTerrainM2: null, logementsTotal: null,
