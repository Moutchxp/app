...
const DECL = (o: Partial<DeclarationsRecapCerfa> = {}): DeclarationsRecapCerfa => ({
  ...
  surfacePlancherTotaleM2: 4994, descriptionProjet: null, descriptionProjetProvenance: 'absent',
  descriptionScission: { genere: null, humain: null, valeurs: null }, decompte: null, absents: [], ambigus: [], present: true, ...o,
});
