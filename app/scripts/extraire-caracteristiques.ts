...
import { extraireCandidats, type RapportExtraction } from '../lib/permis/extractionCaracteristiques';
...
function imprimer(numDau: string, type: string, r: RapportExtraction): void {
  ...
  console.log(`  Cote la plus HAUTE : ${b.coteMax ? `${b.coteMax.valeur} (${prov(b.coteMax.provenance)}, « ${b.coteMax.texteBrut} »)` : '(aucune)'}`);
